...
public class Notice {
	...
	public String toString() {
		return "Notice [noticeID=" + noticeID + ", noticeTitle=" + noticeTitle + ", userID=" + userID + ", noticeDate" + noticeDate
				+ ", noticeContent" + noticeContent + ", noticeAvailable" + noticeAvailable + "]";
